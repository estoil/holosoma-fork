...
from holosoma.config_values.wbt.g1.termination import g1_29dof_wbt_robust_termination, g1_29dof_wbt_termination
...
DEFAULTS = {
    ...
    "g1_29dof_wbt_robust": g1_29dof_wbt_robust_termination,
