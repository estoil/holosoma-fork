"""Whole Body Tracking randomization presets for the X2 robot."""
...
robot_state_dr_at_setup = {
    ...
    # Link mass DR helps whole-body CoM obs / balance rewards transfer.
...
__all__ = ["x2_31dof_wbt_randomization"]
